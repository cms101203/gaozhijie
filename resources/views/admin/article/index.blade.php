...
@section('content')
    <div class="row page-title-row" style="margin:5px;">
        <div class="col-md-8">
            ...
            <div class="xm-sc-txt">
                <input class="form-control" type="text" id="Wz_title"  placeholder="文章标题" />
            </div>
            <div class="xm-sc-txt">
                <input class="form-control" type="text" id="Wz_author"  placeholder="文章作者" />
            </div>
            <div class="xm-sc-txt">
                <input class="form-control" type="number" id="Wz_id"  placeholder="文章ID" />
            </div>
                ...
                columnDefs: [
                    {
                        'targets': -1, "render": function (data, type, row) {
                            var caozuo = '&nbsp;&nbsp;<a class="btn btn-xs btn-warning" href="/admin/article/' + row['id'] + '/edit" class="X-Small btn-xs text-success " title=" 编辑"><i class="fa fa-edit"></i></a>';
