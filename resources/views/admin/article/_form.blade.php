<ul id="myTab" class="nav nav-tabs">
    <li class="active"><a href="#home" data-toggle="tab">文章信息</a></li>
    
</ul>
<div id="myTabContent" class="tab-content" style="padding-top: 20px;">
    <div class="tab-pane fade in active" id="home">
        <div class="form-group">
            <label for="tag" class="col-md-3 control-label">文章名称</label>
            <div class="col-md-5">
        ...
        <div class="form-group">
            <label for="tag" class="col-md-3 control-label">栏目</label>
            <div class="btn-group col-md-1">
                <select class="form-control" name="columns" id="Columns">
                    <option value="0">栏目</option>
                     @foreach($colAll as $v)
                    <option @if($v['id']==$columns) selected @endif value="{{$v['id']}}">{{$v['name']}}</option>
                    @endforeach
        ...
        <div class="form-group">
            <label for="tag" class="col-md-3 control-label">文章来源</label>
            <div class="col-md-5">
                <input type="text" class="form-control typeahead" name="source"  value="{{ $source }}"  data-items="8"  />
            </div>
        </div>
        <div class="form-group">
            <label for="tag" class="col-md-3 control-label">作者</label>
            <div class="col-md-5">
                <input type="text" class="form-control typeahead" name="author" value="{{ $author }}"  data-items="8"  />
            </div>
        </div>
        <div class="form-group">
            <label for="tag" class="col-md-3 control-label">关键词</label>
            <div class="col-md-5">
                <input type="text" class="form-control typeahead" name="keywords"  value="{{ $keywords }}"  data-items="8"  />
            </div>
        </div>
        <div class="form-group">
            <label for="tag" class="col-md-3 control-label">配图</label>
            <div class="col-md-2 thumb-wrap">
                ...
                <input type="hidden" value="3-1-{{$logo['xid']}}" id="ImgBs">
                <input type="hidden" name="picid" value="{{$logo['id']}}" id="PicID" />
                @else
                <img id="logo" src="" width="121" height="75">
                <input type="hidden" value="3-1" id="ImgBs">
                <input type="hidden" name="picid" value="" id="PicID" />
                @endif
           </div>
        </div> 
        <div class="form-group">
            <label for="tag" class="col-md-3 control-label">文章简介</label>
            <div class="col-md-4">
