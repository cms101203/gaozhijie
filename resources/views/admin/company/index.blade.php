...
@section('content')
    <div class="row page-title-row" style="margin:5px;">
        <div class="col-md-6">
            <div class="col-md-2">
                <input class="form-control" type="text" id="CID"  placeholder="公司ID" />
            </div>
            <div class="col-md-5">
                <input class="form-control" type="text" id="CNAME"  placeholder="公司名字" />
            </div>
            <div class="col-md-2">
        ...
        <div class="col-md-6 text-right">
            <a href="/admin/company/create" class="btn btn-success btn-md">
                <i class="fa fa-plus-circle"></i> 添加公司
            </a>
        </div>
    </div>
    <div class="row page-title-row" style="margin:5px;">
                ...
                <div class="col-xs-12">
                    ...
                    <table id="tags-table" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th data-sortable="false">公司logo</th>
                            <th data-sortable="false">公司名称</th>
                            <th data-sortable="false">公司地址</th>
                            <th data-sortable="false">公司官网</th>
                            <th data-sortable="false">联系电话</th>
                            <th data-sortable="false">企业三证</th>
                            <th data-sortable="false">项目数量</th>
        ...
        $(function () {
            var table = $("#tags-table").DataTable({
                ...
                ajax: {
                    ...
                    "data": function ( d ) {
                       //添加额外的参数传给服务器
                        d.search['cid'] = $('#CID').val();
                        d.search['status'] = $('#CSTATUS').val();
                        d.search['value'] = $('#CNAME').val();
                    }
                },
                "columns": [
                    {"data": "id"},
                ...
                columnDefs: [
                    ...
                    {
                        'targets':1, "render": function (data, type, row) {
                            var bdstatus = '<img src="'+row['logo']+'" width="121" height="75"/>';
                            return bdstatus;
                        }
                    },
                    {
                    ...
                    },
                    {
                        'targets':6, "render": function (data, type, row) {
                            var bdstatus = row['pape_num']+'/3<a href="/admin/pape/'+row['id']+'/edit">编辑</a>';
                            return bdstatus;
                        }
                    }
                ]
            ...
            $("table").delegate('.delBtn', 'click', function () {
                ...
                $('.deleteForm').attr('action', '/admin/company/' + id);
                $("#modal-delete").modal();
            });
